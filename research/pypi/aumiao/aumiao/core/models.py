...
if TYPE_CHECKING:
	from aumiao.utils.data import NestedDefaultDict
...
class SourceConfig:
	...
	handle_method: str
	# 基础字段映射
	item_id_field: str = "id"  # 举报记录 ID
	report_id_field: str = "report_id"  # 举报 ID
	reason_id_field: str = "reason_id"  # 原因 ID
